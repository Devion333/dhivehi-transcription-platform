...
func main() {
	...
	api := r.Group("/api")
	{
		...
		protected.Use(handlers.RequireAuth())
		{
			...
			protected.GET("/folders", handlers.APIListFolders)
			protected.POST("/folders", handlers.APICreateFolder)
			protected.GET("/folders/:folderId", handlers.APIGetFolder)
			protected.PATCH("/folders/:folderId", handlers.APIUpdateFolder)
			protected.DELETE("/folders/:folderId", handlers.APIDeleteFolder)
			protected.POST("/folders/:folderId/transcripts", handlers.APIAddTranscriptToFolder)
			protected.DELETE("/folders/:folderId/transcripts/:jobId", handlers.APIRemoveTranscriptFromFolder)
