...
// Program Name: audit.go
// Description: Service layer for audit
...
var actionCategories = map[string]string{
	...
	"transcript_added_to_folder":        "folder",
	"transcript_removed_from_folder":    "folder",
	"transcript_moved_between_folders":  "folder",
	"analysis.started":                  "analysis",
	"analysis.completed":                "analysis",
	"analysis.failed":                   "analysis",
	"analysis_review_updated":           "analysis",
	"analysis_review_failed":            "analysis",
	...
	"system_settings_updated":           "system",
	"system_settings_update_failed":     "system",
	"system_settings_restored":          "system",
	"system_settings_restore_failed":    "system",
	"scheduled_cleanup_completed":       "system",
	"scheduled_cleanup_failed":          "system",
}
...
var auditMetadataAllowlist = map[string]map[string]struct{}{
	...
	"transcript.viewed":                 keys("jobId", "referenceNumber", "filename"),
	"transcript.segment_updated":        keys("jobId", "segmentId", "segmentIndex", "changedFields", "referenceNumber", "filename"),
	"speaker_rename_succeeded":          keys("jobId", "speakerKey", "referenceNumber", "filename"),
	"speaker_rename_failed":             keys("jobId", "speakerKey", "referenceNumber", "filename"),
	"speaker_name_reset":                keys("jobId", "speakerKey", "referenceNumber", "filename"),
	...
	"folder_created":                    keys("folderId"),
	"folder_updated":                    keys("folderId"),
	"folder_deleted":                    keys("folderId"),
	"transcript_added_to_folder":        keys("folderId", "jobId"),
	"transcript_removed_from_folder":    keys("folderId", "jobId"),
	"transcript_moved_between_folders":  keys("jobId", "previousFolderId", "newFolderId"),
	"analysis.started":                  keys("analysisStatus", "provider", "jobId", "referenceNumber", "filename"),
	"analysis.completed":                keys("analysisStatus", "durationMs", "provider", "jobId", "referenceNumber", "filename"),
	"analysis.failed":                   keys("analysisStatus", "durationMs", "provider", "jobId", "referenceNumber", "filename"),
	"analysis_review_updated":           keys("jobId", "previousStatus", "newStatus", "hasNote", "referenceNumber", "filename"),
	"analysis_review_failed":            keys("jobId", "previousStatus", "newStatus", "hasNote", "referenceNumber", "filename"),
	"search.executed":                   keys("queryLength", "page", "pageSize", "statusFilter", "categoryFilter", "resultCount"),
	"transcript_download_succeeded":     keys("jobId", "format", "referenceNumber", "filename"),
	"transcript_download_failed":        keys("jobId", "format", "referenceNumber", "filename"),
	"audit_export_succeeded":            keys("rowCount", "filterTypes", "truncated"),
	"audit_export_failed":               keys("rowCount", "filterTypes", "truncated"),
	"export.pdf_generated":              keys("jobId", "format", "includeAnalysis", "referenceNumber", "filename"),
	"export.pdf_failed":                 keys("jobId", "format", "includeAnalysis", "referenceNumber", "filename"),
	...
	"system_settings_updated":           keys("changedFields", "changes"),
	"system_settings_update_failed":     keys("changedFields"),
	"system_settings_restored":          keys("changedFields"),
	"system_settings_restore_failed":    keys("changedFields"),
	"scheduled_cleanup_completed":       keys("auditEventsDeleted", "notificationsDeleted", "auditRetentionDays", "notificationRetentionDays", "trigger"),
	"scheduled_cleanup_failed":          keys("failureCode", "trigger"),
}
