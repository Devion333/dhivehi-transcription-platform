...
// Program Name: api_errors.go
// Description: Service layer for api_errors
...
const (
	...
	ErrCodeFolderNameRequired         = "FOLDER_NAME_REQUIRED"
	ErrCodeFolderNameExists           = "FOLDER_NAME_EXISTS"
	ErrCodeFolderNotEmpty             = "FOLDER_NOT_EMPTY"
	ErrCodeTranscriptAlreadyInFolder  = "TRANSCRIPT_ALREADY_IN_FOLDER"
	ErrCodeTranscriptNotInFolder      = "TRANSCRIPT_NOT_IN_FOLDER"
