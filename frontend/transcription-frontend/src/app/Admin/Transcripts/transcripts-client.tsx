...
export function AdminTranscriptsClient() {
  ...
  return (
    <PageContainer>
      <PageHeader title="Transcript Administration" description="Operational oversight for transcript ownership, status, review state, reassignment, and deletion." actions={<Button variant="outline" onClick={() => setReload((value) => value + 1)}><RefreshCcw className="h-4 w-4" /> Refresh</Button>} />
              ...
              <CardContent className="grid gap-3 p-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-center">
                <div className="min-w-0 space-y-2">
                  ...
                  <div className="grid gap-2 text-sm text-muted-foreground sm:grid-cols-2 lg:grid-cols-5">
                    ...
                    <span><StatusBadge status={item.analysisReviewStatus} /></span>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button asChild size="sm" variant="outline"><Link href={`/Transcripts/Details?job_id=${encodeURIComponent(item.jobId)}`}>Reassign</Link></Button>
